...
random.seed()
a = formgenerator.generate_random_form_from_distinctness(8,2)
b = rhythmgenerator.stretch_form_randomly(a,8)
c = rhythmgenerator.get_formal_length_tuples(a,b,4)
a2 = formgenerator.generate_random_form_from_distinctness(8,2)
b2 = rhythmgenerator.stretch_form_randomly(a2,8)
c2 = rhythmgenerator.get_formal_length_tuples(a2,b2,8)
a3 = formgenerator.generate_random_form_from_distinctness(8,2)
...
cc3 = {}
for x, y in set(c):
    aa = formgenerator.generate_random_form_from_distinctness(2,2,x)
    bb = rhythmgenerator.stretch_form_randomly(aa,y)
    cc1[x] = rhythmgenerator.get_formal_length_tuples(aa,bb,2)
for x, y in set(c2):
    aa = formgenerator.generate_random_form_from_distinctness(3,2,x)
    bb = rhythmgenerator.stretch_form_randomly(aa,y)
    cc2[x] = rhythmgenerator.get_formal_length_tuples(aa,bb,1)
for x, y in set(c3):
    aa = formgenerator.generate_random_form_from_distinctness(3,2,x)
    bb = rhythmgenerator.stretch_form_randomly(aa,y)
    cc3[x] = rhythmgenerator.get_formal_length_tuples(aa,bb,1)
...
for x, y, z in zip(d1,d2,d3):
	...
	scr3.append((xx[1],trans3.index(xx[0])))
accum = 0
accumscr1 = []
for x, y in scr1:
    accumscr1.append((accum, y, '1_drum'))
    accum += x
accum = 0
accumscr2 = []
for x, y in scr2:
    accumscr2.append((accum, y, '2_drum'))
    accum += x
accum = 0
accumscr3 = []
for x, y in scr3:
    accumscr3.append((accum, y, '3_drum'))
    accum += x

accumscr = accumscr1+accumscr2+accumscr3
deltascr = []
prev = 0
for x, y, z in sorted(accumscr):
    deltascr.append((x - prev, z, y))
    prev = x
